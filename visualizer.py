...
class BrainVisualizer(ctk.CTk):
    ...
    def create_widgets(self):
        ...
        self.tk_axis_label.grid(row=0, column=3, sticky="nsew")
        ...
        self.tk_axis_cbox.grid(row=1, column=3, sticky="nsew", padx=15, pady=15)
        ...
        self.tk_zoom_label.grid(row=0, column=4, sticky="nsew")
        ...
        self.tk_zoom_cbox.grid(row=1, column=4, sticky="nsew", padx=15, pady=15)
        ...
        self.tk_shape_label.grid(row=0, column=5, sticky="nsew")
        ...
        self.tk_shape_toggle.grid(row=1, column=5, sticky="nsew")
        ...
        self.tk_current_slice_container.grid(row=1, column=6, sticky="nsew", padx=2, pady=2)
